...
window.__ModuleLoader__.load({
 ...
 "dsh-key-limits": {
  "activeNoSession": "сессия",
  "activeNone": "—",
  "add": "Добавить",
  "addKey": "Добавить ключ",
  "allSub": "Все ключи",
  "allTitle": "Лимиты подписки",
  "balance": "Баланс",
  "cancel": "Отмена",
  "close": "Закрыть",
  ...
  "errTitle": "Ограничения ключа: ошибка интерфейса",
  "extra": "Дополнительно",
  "fillFields": "Заполните:",
  "floatTitle": "Лимиты клавиш — клик: все, перетаскивание: перемещение",
  "labelOptional": "Метка (необязательно)",
  "loading": "Загрузка…",
  "noQuota": "Нет данных о квоте",
  "noSubs": "Ключей пока нет",
  "oneTitle": "Лимиты активных ключей",
  "pctLeft": "слева",
  "pickDash": "— выбрать —",
  ...
  "secret": "Секрет / ключ",
  "stale": "устаревший",
  "subtitle": "API-ключи и квоты подписки",
  "title": "Лимиты ключей",
  "uiHint": "Плавающий чип и строка компоновки — интерфейс cordis.",
  "updated": "Обновлено"
 },
 "dsh-market": {
