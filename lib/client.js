...
window.__ModuleLoader__.load({
 ...
 "betterSidebar": {
  ...
  "sideChatSaved": "Сохранено как новая сессия {session}",
 ...
 "dsh-gitea": {
  "baseUrl": "URL экземпляра",
  "baseUrlHint": "например, https://gitea.example.com",
  "collapse": "Свернуть",
  "description": "Инструменты и учетные данные Gitea или Forgejo.",
  "discard": "Отменить",
  "expand": "Развернуть",
  "intro": "Создайте учетные данные DSH, вставьте туда API-токен, затем введите только название учетных данных ниже (например, GITEA_TOKEN). Никогда не вставляйте токен в эту форму.",
  "loading": "Загрузка…",
  "save": "Сохранить",
  "saveFailed": "Не удалось сохранить",
  "saving": "Сохранение…",
  "title": "Гитеа",
  "tokenEnv": "Имя учетных данных",
  "tokenEnvHint": "Название учетных данных DSH, а не самого токена. По умолчанию GITEA_TOKEN.",
 ...
 "dsh-key-rotation": {
  ...
  "brokenKey": "сломано (3× AUTH)",
  "cardDesc": "Поворот API-ключей для каждого провайдера: пулы ключей, автоматический переход на резерв при ошибках квоты/ограничения скорости, охлаждение и восстановление.",
  "codesTitle": "Включите эти {сбои}",
  "cooldown": "Время ожидания после ошибки (мс)",
  "desc": "Поворот API-ключей для каждого провайдера. Для каждого провайдера перечислите его API-ключи (имена переменных окружения, хранящиеся в учетных данных DSH). Плагин направляет модель через ключи провайдера по порядку и переключается на следующий при превышении квоты или ограничения скорости.",
  "discard": "Отменить",
  "exportOne": "Вниз",
  "exportPools": "Экспорт",
  "hoursAgo": "{n} ч назад",
  "importEnv": "Импортировать .env",
  "importPools": "Импорт",
  "justNow": "только что",
  "keyActive": "используется",
  "keyCooling": "охлаждение, {s}с",
  "keyFromEnv": "из окружения, только для чтения здесь",
  "keyHint": "Значение хранится в учетных данных DSH и никогда не отправляется обратно в браузер — отображаются только последние 5 символов. Имена генерируются автоматически; наведите курсор на ключ, чтобы увидеть используемое имя.",
  "keyLabel": "Ключ {n}",
  "keyMissing": "нет такого учетного {credential}",
  "keyReady": "готово",
  "keySave": "Сохранить ключ",
  "keySaved": "сохранено",
  "keyValuePlaceholder": "вставьте ключ, затем {Save}",
  "keyWriteFailed": "не удалось сохранить ключ: {msg}",
  "loading": "Загрузка…",
  "minutesAgo": "{n} мин назад",
  "moveDown": "Переместить вниз",
  "moveUp": "Переместить вверх",
  "noProviders": "Нет зарегистрированных поставщиков в DSH — пока не из чего выбирать.",
  "notRegistered": "не зарегистрирован",
  "poolExhausted": "пул исчерпан — все ключи охлаждаются",
  "providersTitle": "Провайдеры и их ключи",
  "removeKey": "Удалить ключ {key}",
  "removeProvider": "Удалить провайдера",
  "resetCooldown": "Сбросить время восстановления",
  "resetting": "Сброс…",
  "save": "Сохранить",
  "saving": "Сохранение…",
  "subtitle": "Поворот API-ключей для каждого провайдера: пулы ключей, автоматический переход на резерв при ошибках квоты/ограничения скорости, охлаждение и восстановление.",
  "switchCodes": "Переключить коды (через запятую)",
  "switchesNone": "ещё нет переключателей",
  "switchesSome": "переключатели: {n} · последний: {reason}, {ago}",
  "testAll": "Проверьте все {keys}",
  "testFail": "ОШИБКА",
  "testKey": "Тест",
  "testOk": "ОК",
  "testing": "Тестирование…",
  "title": "Ротация ключей {placeholders}",
  "usedAgo": "{ago} назад"
 },
 "dsh-market": {
  ...
  "confirm": "Подтвердить",
  "confirmInstall": "Подтвердите установку {placeholder}",
  ...
  "conflictKeepNote": "Создать {count}",
  ...
  "conflictSwap": "Переключиться на этот {placeholder}",
  ...
  "opBlockedCard": "Невозможно установить · {details}",
  ...
  "opInstalling": "Установка {placeholder}",
  "opKind_install": "Установить",
  "opKind_uninstall": "Удалить {placeholder}",
  ...
  "rollbackNow": "Откатить {placeholder}",
  ...
  "setChannelSwitch": "Переключиться на {placeholder}",
  ...
  "setSelfUpToDateHint": "Создать {count} новых {count, plural, one {чат} few {чата} many {чатов}}",
 ...
 "dsh-subscriptions": {
  ...
  "removeSlot": "Удалить слот {slot}",
  "save": "Сохранить",
  "saved": "Сохранено",
  "show": "Показать",
  "storedAs": "Хранится как {placeholder}",
  ...
  "verifyAccount": "Подтвердите {account}",
 ...
 "dsh-tts": {
  ...
  "announce": "Объявить одобрения {placeholders}",
  ...
  "bargeIn": "Замолкают, когда вы говорите {placeholder}",
  ...
  "fromEnv": "Установлено в окружении {environment}",
  "general": "Общие",
  "language": "Язык",
 ...
 "dsh-vision-bridge": {
  ...
  "baseURL": "Базовый URL",
  "channels": "Каналы",
  "channelsHint": "Дополнительные конечные точки зрения (совместимые с OpenAI, Ollama, пользовательские). Пусто — автоматический выбор из каталога.",
  "current": "Текущий: {provider} / {model}",
  "currentAuto": "Авто (автоматический выбор)",
  "describeStrategy": "Опишите стратегию",
  "empty": "Пожалуйста, войдите в свою учетную запись {accountName}",
  "escalation": "Эскалация",
  "escalationAuto": "Автоматическое повышение сложности (повторный анализ сложных изображений)",
  "escalationSimple": "Простой только (один проход)",
  ...
  "loading": "…",
  "mode": "Режим",
  "modeHybrid": "Гибридный (автоперезапись + инструменты)",
  "modeLlm": "Только LLM (автоперезапись, инструменты всё ещё доступны)",
  "modeTools": "Только инструменты (без авто-перезаписи, модель должна вызывать describe_image)",
  "model": "Модель",
  "modelInvalid": "Модель не принимает изображения",
  "noVisionModels": "В каталоге нет моделей для анализа изображений (ввод: [текст, изображение]) — добавьте их в Настройки → Модели.",
  "protocol": "Протокол",
  "protocolOpenaiChat": "чат OpenAI",
  "protocolOpenaiResponses": "ответы от OpenAI",
  "provider": "Поставщик услуг по зрению",
  "remove": "Удалить",
  "reqBoth": "Выберите и провайдера, и модель, или оставьте оба поля пустыми для автоматического выбора",
  ...
  "saved": "Сохранено",
  "saving": "Сохранение…",
  "strategyAuto": "Авто (использовать LLM для зрения)",
  "strategyCacheOnly": "Только кэш (без сети)",
  "strategyLlm": "Vision {LLM}",
  "strategyOcrLocal": "Локальное OCR (зарезервировано)",
  "subtitle": "Изображения в чате обрабатываются моделью зрения, которую вы выбираете здесь. Оставьте оба поля пустыми, чтобы автоматически выбрать первую модель с поддержкой зрения из каталога.",
  "testFail": "Ошибка: {err}",
  "testOk": "ОК ({ms}мс)",
  "testVision": "Проверка зрения",
  "testing": "Тестирование…",
  "title": "Зрение",
  "type": "Тип"
 },
 "dsh-voice": {
  "addCustom": "Добавьте своего провайдера {provider}",
  "addProvider": "Добавить поставщика",
  ...
  "pauseMs": "Пауза, завершающая фразу, {ms}",
  ...
  "saved": "Сохранено ✓",
  "secondsShort": "с",
  "sendingIn": "Отправка агенту в {placeholder}",
  ...
  "whisperEndpoint": "Локальный шепот: {endpoint}",
