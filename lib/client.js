...
window.__ModuleLoader__.load({
 ...
 "context-doctor": {
  ...
  "cd.subtitle": "Аудит контекста {resident}",
  ...
  "cd.total": "Общее количество жителей {count}",
 ...
 "dsh-context": {
  ...
  "form.snapshot": "Снимок состояния {placeholder}",
  "gran.step": "Шаг",
  "gran.turn": "Повернуть",
  "kind.compaction": "Компактный",
  "kind.inject": "Внедрить {placeholder}",
  "kind.model": "Переключить",
  "kind.prune": "Обрезать {placeholders}",
  ...
  "overview.used": "использовано контекста: {context_used}",
  ...
  "stats.cacheHit": "Кэш-попадания {placeholders}",
 ...
 "settings.commandcode": {
  ...
  "loginSuccess": "Вошли как {username}",
  "loginTimeout": "Истекло время ожидания ответа авторизации; попробуйте снова.",
  "loginTitle": "Войдите, чтобы получить ключ {key}",
  ...
  "usageCost": "Потратить",
  "usageError": "Не удалось получить данные об использовании {placeholder}",
  ...
  "usageNetworkHint": "На сервер не поступило ни одного запроса. Проверьте подключение к сети или настройку базового API {placeholder}.",
 ...
 "usageStats": {
  ...
  "col.hour": "Время",
  "col.input": "Ввод",
  "col.model": "Модель {placeholder}",
  "col.models": "Модели",
  "col.output": "Вывод",
  "col.price": "Оцените {placeholder}",
