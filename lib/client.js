...
window.__ModuleLoader__.load({
 ...
 "dsh-spendmeter": {
  ...
  "alerts": "Оповещения",
  "balanceRem": "баланс:",
  "budgetPace": "Бюджет (темп за 7 дней)",
  "cancel": "Отмена",
  "cc.subtitle": "квоты и использование",
  "cc.title": "Тратить",
  "close": "Закрыть",
  "cost": "Стоимость",
  "csv": "CSV",
  "dataPath": "Данные: ~/.dsh/storages/dsh-spendmeter/",
  "daySpend": "Траты по дням",
  "dayToZero": "дней до нуля",
  "daysToZero": "дней до нуля",
  "delete": "Удалить",
  "deleteSubConfirm": "Удалить подписку «",
  "dockLoading": "Сессия: …",
  "dockNoData": "Сессия: нет данных",
  "dockNoSession": "Сессия: нет активной сессии",
  "dockPrefix": "Сессия:",
  "errTitle": "Счётчик трат: ошибка интерфейса",
  "fillFields": "Заполните:",
  "filterPlaceholder": "Фильтр по поставщику/модели…",
  "hourSpend": "Расходы по часам",
  "labelOptional": "Метка (необязательно)",
  "last": "Последний",
  "leftUsed": "осталось · использовано",
  "loading": "Загрузка…",
  "model": "Модель",
  "models7d": "Модели (7д)",
  "modelsFor": "Модели · {provider}",
  "modelsPrefix": "Модели ·",
  "myAccount": "мой аккаунт",
  "noAlerts": "Нет активных оповещений",
  "noData": "Нет данных",
  "noDayData": "Нет ежедневных данных",
  "noModelData": "Нет данных модели",
  "noQuotaData": "Нет данных о квоте",
  "noSubsYet": "Подписок пока нет",
  "oneAccount": "Один аккаунт за раз",
  "pctLeft": "слева",
  "perDay": "день",
  "period.30d": "30 дней",
  "period.7d": "7 дней",
  ...
  "periodLabel": "Период: {label}",
  "periodWord": "период",
  "pickDash": "— выбрать —",
  "pickProvider": "Выберите {provider}",
  "pillTitle": "Счетчик расходов — клик: панель, перетаскивание: перемещение",
  "provider": "Провайдер",
  "quotaNotLoaded": "Квоты не загружены",
  "quotaWord": "квота {placeholder}",
  "refresh": "Обновить",
  ...
  "reset.h": "ч",
  "reset.m": "м",
  "reset.none": "обновить: нет данных",
  "reset.prefix": "обновить через {time}",
  "reset.s": "с",
  "reset.short": "сбросить",
  "reset.soon": "обновить: скоро",
  "resetH": "ч",
  "resetIn": "обновить через {time}",
  "resetM": "м",
  "resetNone": "обновить: нет данных",
  "resetS": "с",
  "resetSoon": "обновить: скоро",
  "retry": "Повторить",
  "save": "Сохранить",
  "saveError": "ошибка сохранения",
  "saving": "Сохранение…",
  "sectionLabel": "Подписки (квоты)",
  "session": "Сессия",
  "sessionWord": "сессия",
  "settingsTitle": "Настройки",
  "share": "Поделиться",
  "sidebarLabel": "Потратить {amount}",
  "sidebarTitle": "Расходы и квоты",
  "slash.limits": "Лимиты для всех подписок {placeholders}",
  "slash.meter": "Счетчик расходов (обзор)",
  "slash.quota": "Квоты подписки {placeholders}",
  "slash.requests": "Последние запросы",
  "slash.sessions": "Сессии по затратам {placeholders}",
  "slash.spend": "Обзор расходов и использования",
  "slash.subs": "Подписки и квоты",
  "spendMonth": "потрачено в этом месяце:",
  "spendPrefix": "потратить:",
  "spendWeek": "потрачено за эту неделю:",
  "stale": "устаревший",
  "subsHint": "Ключи и куки для отслеживания квот провайдера",
  "subsKeysHint": "Ключи и куки для отслеживания квоты провайдера",
  "subsTitle": "Подписки",
  "subscription": "Подписка",
  "subtitle": "Подписки, квоты и интерфейсы управления расходами",
  "tab.limits": "Лимиты",
  "tab.overview": "Обзор",
  "tab.requests": "Запросы",
  "tab.sessions": "Сессии",
  "tab.settings": "Настройки",
  "tab.spend": "Потратить {amount}",
  "tab.subs": "Подписки",
  "time": "Время",
  "title": "Расходуйте {Meter}",
  "tokCache": "кеш",
  "tokIn": "в",
  "tokOut": "выход",
  "tokenCache": "Кэш",
  ...
  "topProviders": "Лучшие {providers}",
  "uiHint": "composerDock / sidebar / deepseekCnyFloat — интерфейс cordis ui.*",
  "updatedAt": "Обновлено",
  "usagePrefix": "Использование ·",
  "used": "Использовано",
  "usedPrefix": "Использовано {count}",
  "week52": "Расходы за 52 недели"
 },
 "dsh-subscriptions": {
