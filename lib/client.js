...
? generateBugReportSnippet({ key: k, ns, original: origText || rawText, current: rawText, override: textarea.value.trim(), pkgVersion: '0.3.11' })
...
const [upStatus, setUpStatus] = React.useState({currentVersion: '0.3.11',latestVersion: undefined,updateAvailable: false
})
