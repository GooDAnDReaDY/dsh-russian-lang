...
window.__ModuleLoader__.load({
 ...
 "dsh-messenger-gateway": {
  "advanced": "Телеграм опрос",
  "agent": "Агент",
  "allowedIds": "Разрешенные идентификаторы пользователей {placeholders}",
  "allowedIdsHint": "Через запятую. Пусто = все пользователи",
  "botToken": "Токен бота (только для записи)",
  "botTokenHint": "Оставьте пустым, чтобы сохранить текущий токен",
  "description": "Телеграм бот: текст, голос, фото и документы.",
  "disableTelegram": "Отключить Telegram",
  "enableTelegram": "Включить Telegram",
  "groupMention": "Группы требуют @упоминания / ответа / команды",
  "groupsEnable": "Отвечайте в группах",
  "hideAdvanced": "Скрыть дополнительные {параметры}",
  "idleTimeout": "тайм-аут простоя (сек)",
  "instruction": "Дополнительная инструкция для агента",
  "instructionHint": "Добавлено к каждому сообщению в мессенджере",
  "instructionPlaceholder": "Пусто = встроенное реле",
  "loading": "Загрузка…",
  "maxDocMb": "Максимальный размер документа (МБ)",
  "maxImageMb": "Максимальный размер фото (МБ)",
  "maxMessageLength": "Максимальная длина ответа (символов)",
  "maxTextKb": "Максимальный текст из документа (КБ)",
  "media": "Медиа",
  "model": "Модель",
  "modelHint": "Пусто = значение по умолчанию DSH",
  "notifyBridge": "Уведомить → Домашний Telegram",
  "notifyBridgeHint": "ошибка из веб-сессий (не msgw-*)",
  "notifyHome": "Уведомить имя дома",
  "pairing": "Запросы на сопряжение",
  ...
  "photoPrompt": "Дождитесь вопроса (рекомендуется)",
  "photoRun": "Ответить сразу {placeholder}",
  "pollInterval": "интервал опроса {pollIntervalMs}",
  "pollTimeout": "таймаут опроса {pollTimeoutSeconds} секунд",
  "progressEnable": "Сообщение о прогрессе (размышление → удаление → завершение)",
  "provider": "Провайдер",
  "providerHint": "Пусто = DSH по умолчанию",
  "reactionsEnable": "Реагируйте во время обработки (👀)",
  "save": "Сохранить",
  "saving": "Сохранение…",
  "sessionScope": "Область групповой сессии",
  "sessionScopeChat": "Доступно для общего использования в чате/теме",
  "sessionScopeUser": "На пользователя (рекомендуется)",
  ...
  "title": "Шлюз мессенджера",
  "transport": "Транспорт",
  "transportPoll": "Длинный опрос (getUpdates)",
  "transportWebhook": "Вебхук",
  "tts": "Голосовые ответы",
  "ttsEnable": "Голосовые ответы через dsh-tts",
  "ttsMaxChars": "Максимум символов в речи",
  "turnTimeout": "Таймаут хода агента (сек)",
  "voiceMode": "Режим голосовых ответов",
  "voiceModeAlways": "Всегда попробуйте TTS",
  "voiceModeMirror": "Зеркалировать входящий голос",
  "voiceModeOff": "Выкл (кроме случая /voice on)",
  "webhookSecret": "Секрет вебхука (только запись)",
  "webhookSecretHint": "Оставьте пустым, чтобы сохранить текущее",
  "webhookUrl": "Публичный URL вебхука",
  "webhookUrlHint": "Полный HTTPS-URL, на который Telegram будет отправлять POST-запросы"
 },
 "dsh-subscriptions": {
 ...
 "dsh-vision-bridge": {
  ...
  "filterProviders": "Фильтровать поставщиков…",
