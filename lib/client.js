...
? generateBugReportSnippet({ key: k, ns, original: origText || rawText, current: rawText, override: textarea.value.trim(), pkgVersion: '0.3.4' })
...
t('updaterCurrent').replace('{version}', upStatus.currentVersion || '0.3.4')),
