...
? generateBugReportSnippet({ key: k, ns, original: origText || rawText, current: rawText, override: textarea.value.trim(), pkgVersion: '0.3.10' })
...
const [upStatus, setUpStatus] = React.useState({currentVersion: '0.3.10',latestVersion: undefined,updateAvailable: false
})
