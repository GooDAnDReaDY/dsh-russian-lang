...
// нечего, но у переключателя есть сохраняемая настройка: регистрируем её схему
...
export function apply(ctx) {
  ctx.inject(['settings'], (settingsCtx) => {
    settingsCtx.settings.register(settingsNamespace('russianLang'), RussianLangSettingsSchema)
  })
}
