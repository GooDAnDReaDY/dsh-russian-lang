...
import { getCoreDictionaries, getPluginDictionaries, getZhRuMap } from './locales.js'
...
export function apply(ctx) {
  ...
  // Web endpoints: One-click plugin updater, modular plugin dictionary serving, & translator gateway
      ...
      try {
        const mount = () => {
            ...
            unregDict = ws.register({
              ...
              handler: async (request, response) => {
                try {
                  ...
                  response.end(JSON.stringify(Object.assign({}, core, plugins, { core, plugins, zhRu })))
                } catch (err) {
          ...
          return () => {
            ...
            if (typeof unregDict === 'function') unregDict()
          }
        }
