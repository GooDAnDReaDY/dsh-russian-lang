...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Ключей_UI-6808-6366f1.svg?style=for-the-badge&labelColor=1e1b4b" alt="6808 ключей">
...
graph LR
    ...
    subgraph TranslationLayer [Слой перевода и адаптации — 6808 ключей / 100% вычитано]
        Loader --> CoreDict[30+ Пространств имён ядра DSH / 1225 ключа]
        Loader --> PluginDict[30+ Плагинов экосистемы DSH / 5404 ключ]
...
6. **Хоткей транслитерации (<kbd>Alt+T</kbd>)**:
   ...
   - *(Deprecated since v0.2.15: экспериментальный UI-перехватчик удалён для обеспечения беспрепятственного нативного ввода Lexical; программная функция `phoneticTranslit` сохранена в `lib/pure.js`).*
