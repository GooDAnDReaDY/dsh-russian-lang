...
<p align="center">
  <a href="https://www.npmjs.com/package/@goodandready/dsh-russian-lang"><img src="https://img.shields.io/badge/npm-v0.2.13-6366f1.svg?style=for-the-badge&labelColor=1e1b4b" alt="npm version"></a>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Ключей_UI-5765-6366f1.svg?style=for-the-badge&labelColor=1e1b4b" alt="5765 ключей">
...
graph LR
    ...
    subgraph TranslationLayer [Слой перевода и адаптации — 5765 ключей / 100% вычитано]
        Loader --> CoreDict[30+ Пространств имён ядра DSH / 1225 ключа]
        Loader --> PluginDict[30+ Плагинов экосистемы DSH / 4540 ключ]
...
6. **Хоткей транслитерации (<kbd>Alt+T</kbd>)**:
   ...
   - *(Deprecated since v0.2.13: экспериментальный UI-перехватчик удалён для обеспечения беспрепятственного нативного ввода Lexical; программная функция `phoneticTranslit` сохранена в `lib/pure.js`).*
